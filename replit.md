...
- **August 2025**: Updated application logo from anchor icon to official QAAQ golden duck logo. Profile picture functionality removed due to QAAQ database limitations.
